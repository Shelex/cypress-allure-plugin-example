context('Actions', () => {
  ...
  it('.focus() - focus on a DOM element', () => {
      cy.allure().tms('docs', 'https://on.cypress.io/focus');
      cy.get('.action-focus')
          .focus()
  ...
  it('.dblclick() - double click on a DOM element', () => {
      cy.allure().tms('docs', 'https://on.cypress.io/dblclick').description(`
  ...
  it('.rightclick() - right click on a DOM element', () => {
      cy.allure().tms('docs', 'https://on.cypress.io/rightclick')
          .description(`
